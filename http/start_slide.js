...
const IMAGE_WIDTH = 1880;//한번 이동 시 IMAGE_WIDTH만큼 이동한다.
//DOM
const backBtn = document.querySelector(".back")
const nextBtn = document.querySelector(".next")
const images = document.querySelector(".images")
const more_infoBtn = document.querySelector(".more_info")
...
function more_info(){
  if(pages === 0){
    window.location.href = '/linked_site/region/yeongwol.html';
  }
  else if(pages === 1){
    window.location.href = '/linked_site/region/sokcho.html';
  }
  else if(pages === 2){
    window.location.href = '/linked_site/region/chuncheon.html';
  }
}